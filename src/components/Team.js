  ...
  return (
    <section data-theme='corporate' className='p-4 border-b border-gray-200 mb-4'>
      <div className='text-center mb-8'>
        <h2 className='text-xl md:text-2xl lg:text-3xl font-semibold text-primary mb-4'>Our Team</h2>
            ...
            <figure className='relative w-full h-40 flex items-center justify-center'>
              ...
              {isPageLoaded && (
                <div className='mask mask-circle w-24 h-24 flex items-start justify-center'>
                  <Image src={member.photo} alt={member.name} width={96} height={96} style={{ width: '96px', height: '96px', objectFit: 'cover', objectPosition: 'top' }} loading='lazy' placeholder='blur' blurDataURL='https://fastly.picsum.photos/id/278/20/20.jpg?blur=10&hmac=mIMB2jGMPxpBwZbfY64XdKqrhu9AL0cSmKMFci1Rl9w' />
                </div>
              )}
            </figure>
            <div className='card-body bg-base-200 text-center p-4'>
              <h3 className='text-xl font-semibold mb-2'>{member.name}</h3>
              <div className='badge badge-primary text-white rounded-full mb-2 mx-auto'>{member.role}</div>
