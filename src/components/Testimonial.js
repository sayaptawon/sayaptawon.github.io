          ...
          <div className='w-full mx-auto bg-white border border-gray-300 rounded-lg shadow-lg overflow-hidden p-6'>
            {loading ? (
              <div className='flex flex-col items-center p-4'>
                <div className='w-36 h-36 bg-gray-300 rounded-full skeleton mb-4'></div>
              ...
              <div className={`flex flex-col items-center p-4 transition-opacity duration-500 ease-in-out ${transition}`}>
                <div className='mask mask-hexagon mb-4'>
                  <img src={photo} alt={`Photo of ${name}`} className='w-36 h-36 mask mask-hexagon object-cover' />
                </div>
