        ...
        <div className='container mx-auto px-4'>
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8'>
            ...
            <div className='flex flex-col min-w-[250px]'>
              <h4 className='text-lg font-semibold mb-4 text-white border-b-2 border-gray-600 pb-2 text-center sm:text-left'>
                Tentang Kami
              </h4>
              <p className='text-gray-400'>
                Sistem Layanan Terpadu Rutan Wonosobo adalah sebuah sistem yang
                mengintegrasikan berbagai layanan publik yang ada di Rutan
                Wonosobo dalam satu platform.
              </p>
            </div>
          ...
          <div className='flex justify-center space-x-4'>
            {socialMediaData.map((social) => (
              <a
                ...
                className='w-12 h-12 flex items-center justify-center rounded-full transition-transform transform hover:scale-110 border-2 border-gray-600 shadow-md'
                style={socialMediaStyles[social.name]}
