...
const Contact = () => {
  ...
  return (
    <Layout
      title='Hubungi Kami'
      description='Hubungi kami untuk pertanyaan, masukan, atau informasi lebih lanjut melalui berbagai saluran komunikasi yang tersedia.'
    >
          ...
          <nav className='w-full'>
            <div className='mx-auto bg-base-100 p-4 rounded shadow border border-gray-200'>
              <ul className='flex flex-wrap items-center text-sm text-gray-700 font-bold font-sans justify-start sm:justify-center'>
                ...
                <li>
                  <span className='px-2 py-1 text-gray-900'>Hubungi Kami</span>
                </li>
              </ul>
            </div>
          </nav>
          ...
          <div className='md:w-1/2 mt-8 md:mt-0 bg-gradient-to-r from-indigo-400 to-purple-600 p-6 rounded-lg shadow-xl'>
            ...
            <ul className='space-y-5'>
              <li className='flex items-center bg-white p-4 rounded-lg shadow-md'>
                ...
                <div className='flex-1'>
                  ...
                  <span className='text-gray-600'>
                    Jl. Pramuka No.1, Sumberan Barat, Wonosobo Bar., Kec.
              ...
              <li className='flex items-center bg-white p-4 rounded-lg shadow-md'>
                ...
                <div className='flex-1'>
                  <span className='block text-lg font-medium text-secondary'>
                    Email:
                  </span>
